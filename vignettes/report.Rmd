...
ape::plot.phylo(my_tree, cex = 0.1, type = "fan") # or just plot(my_tree, cex = 0.1)
...
Make a samller tree of chiroptera families:
```{r}
...
Make a smaller bat tree with 5 taxa that you like:
