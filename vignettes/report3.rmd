...
`Plot Phylo` plots the output of summarize datelife reslts.The output is all the chronograms that have at least two of the taxa that are given as input to get datelife result.
```{r}
